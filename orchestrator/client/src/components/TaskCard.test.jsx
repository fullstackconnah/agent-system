...
describe('TaskCard', () => {
  it('should render the title and count', () => {
    render(<TaskCard title="Pending Tasks" status="pending" tasks={[]} count={0} />);
  ...
  it('should render task items', () => {
    ...
    render(<TaskCard title="Pending Tasks" status="pending" tasks={tasks} count={2} />);
  ...
  it('should display at most 5 tasks', () => {
    ...
    render(<TaskCard title="All" status="pending" tasks={tasks} count={8} />);
  ...
  it('should strip date prefix and .md extension from filename', () => {
    ...
    render(<TaskCard title="Tasks" status="done" tasks={tasks} count={1} />);
  ...
  it('should display project and priority', () => {
    ...
    render(<TaskCard title="Tasks" status="pending" tasks={tasks} count={1} />);
